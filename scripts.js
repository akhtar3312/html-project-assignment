...
let changeIcon=function(x) {
 ...
 let changecolor=function(x) {
   ...
   document.getElementById('bookmark3').style.color = "black";
   document.getElementById('bookmark2').style.color = "black";
   document.getElementById('bookmark1').style.color = "black";
   document.getElementById('bookmarks').style.color = "black";
     x.classList.toggle('fa-solid');
 }
